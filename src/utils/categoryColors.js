...
export const categoryColors = {
  ...
  'format': {
    ...
    bg: 'rgba(59, 130, 246, 0.15)',          /* blue-500 with 15% opacity */
    border: 'rgba(59, 130, 246, 0.3)',         /* blue-500 with 30% opacity */
    glow: 'rgba(59, 130, 246, 0.4)'          /* blue-500 with 40% opacity */
  },
  // 🟢 编码解码 - 翡翠绿
  'encode': {
  ...
  'text': {
    ...
    bg: 'rgba(236, 72, 153, 0.15)',          /* pink-500 with 15% opacity */
    border: 'rgba(236, 72, 153, 0.3)',         /* pink-500 with 30% opacity */
    glow: 'rgba(236, 72, 153, 0.4)'          /* pink-500 with 40% opacity */
  },
  // 🌐 网络工具 - 青空蓝
  'network': {
    icon: '#06B6D4',                        /* cyan-500 */
    bg: 'rgba(6, 182, 212, 0.15)',           /* cyan-500 with 15% opacity */
    border: 'rgba(6, 182, 212, 0.3)',          /* cyan-500 with 30% opacity */
    glow: 'rgba(6, 182, 212, 0.4)'           /* cyan-500 with 40% opacity */
  },
  // 🧡 图像处理 - 活力橙
  'image': {
    icon: '#F97316',                        /* orange-500 */
    bg: 'rgba(249, 115, 22, 0.15)',          /* orange-500 with 15% opacity */
    border: 'rgba(249, 115, 22, 0.3)',         /* orange-500 with 30% opacity */
    glow: 'rgba(249, 115, 22, 0.4)'          /* orange-500 with 40% opacity */
  },
  // 🔴 开发辅助 - 绯红
  'dev': {
    icon: '#EF4444',                        /* red-500 */
    ...
    glow: 'rgba(239, 68, 68, 0.4)'           /* red-500 with 40% opacity */
  },
  // ⚪ AI工具 - 中性白/品牌色
  'ai': {
 ...
 * @returns {Object} 色彩配置对象
 */
export const getCategoryColor = (categoryId) => {
  return categoryColors[categoryId] || {
    icon: '#9CA3AF',                          /* default: gray-400 */
    bg: 'rgba(156, 163, 175, 0.1)',         /* default: gray-400 with 10% opacity */
    border: 'rgba(156, 163, 175, 0.2)',        /* default: gray-400 with 20% opacity */
    glow: 'rgba(156, 163, 175, 0.3)'         /* default: gray-400 with 30% opacity */
  }
}