<template>
  <div class="max-w-8xl mx-auto">
    <!-- 增强型头部 -->
    <div class="mt-4 mb-8">
      <h1 class="text-3xl font-bold mb-3">在线安全工具箱</h1>
      <p class="text-muted-foreground max-w-3xl">专业的数据脱敏、隐私保护、安全检测工具，帮助您保护数据安全，符合GDPR等隐私法规要求。</p>
    </div>
    ...
    <!-- SEO知识库区域 -->
    <SeoKnowledgeBase category="security" />
  </div>
</template>
