<template>
  <div class="max-w-8xl mx-auto">
    <!-- 增强型头部 -->
    <div class="mt-4 mb-8">
      <h1 class="text-3xl font-bold mb-3">在线健康工具箱</h1>
      <p class="text-muted-foreground max-w-3xl">专业的BMI计算、健康指标评估、运动健身工具，支持实时计算和健康建议，关注您的身体健康。</p>
    </div>
    ...
    <!-- SEO知识库区域 -->
    <SeoKnowledgeBase category="health" />
  </div>
</template>
