...
import { 
  Monitor, Browser, Settings, History, Info, List, Zap, Lightbulb, 
  Shield, Code, HelpCircle, ChevronUp, CheckCircle, XCircle, AlertTriangle,
  Chrome, Firefox, Safari, Edge, Apple, Windows, Terminal, HardDrive,
  Ubuntu, Android, Check, X, Globe, Wifi, Key, Hash, Lock, FileText, Database,
...
const iconMap = {
  ...
  Shield, Code, HelpCircle, ChevronUp, CheckCircle, XCircle, AlertTriangle,
  Chrome, Firefox, Safari, Edge, Apple, Windows, Terminal, HardDrive,
  Ubuntu, Android, Globe, Wifi, Key, Hash, Lock, FileText, Database,
  Calendar, Clock, Calculator, Users, Timer, Activity, Regex, FileDiff, Type,
