...
export { setPageTitle, getFullPageTitle, generateToolPageTitle, generateCategoryPageTitle, useSEO } from '../src/composables/useSEO';
export { initToolsData, toggleFavorite, isFavorite, addRecentTool, getFavoriteTools, getRecentTools, clearRecentTools } from '../src/composables/useTools';
export { categoryColors, getCategoryColor } from '../src/utils/categoryColors';
