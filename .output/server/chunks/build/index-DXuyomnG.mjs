...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-8xl mx-auto" }, _attrs))}><div class="mt-4 mb-8"><h1 class="text-3xl font-bold mb-3">\u5728\u7EBF\u56FE\u50CF\u5904\u7406\u5DE5\u5177\u7BB1</h1><p class="text-muted-foreground max-w-3xl">\u56FE\u7247\u538B\u7F29\u3001\u683C\u5F0F\u8F6C\u6362\u3001\u5C3A\u5BF8\u8C03\u6574\u3001\u6C34\u5370\u6DFB\u52A0\u7B49\u56FE\u50CF\u5904\u7406\u5DE5\u5177\uFF0C\u65E0\u9700\u4E0A\u4F20\u5373\u53EF\u672C\u5730\u5904\u7406\u3002</p></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-12"><!--[-->`);
      ...
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_sfc_main$2, { category: "image" }, null, _parent));
      _push(`</div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/category/image/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DXuyomnG.mjs.map
